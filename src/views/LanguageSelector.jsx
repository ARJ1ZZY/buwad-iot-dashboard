  ...
  return (
    <div className="min-h-screen bg-[#E8EDF3] dark:bg-[#1A202C] transition-colors duration-300">
      <div className="max-w-md mx-auto min-h-screen flex flex-col">
        ...
        {/* Header with BUWAD logo and Theme button */}
        <header className="sticky top-0 z-20 px-4 pt-4 pb-3 border-b bg-[#E8EDF3]/95 dark:bg-[#1A202C]/95 backdrop-blur-md border-[#BDBCBD] dark:border-white/10 transition-colors duration-300">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-black tracking-tight text-[#00386D] dark:text-[#F7FAFC]" style={{ fontFamily: 'Space Grotesk' }}>
              BUWAD
            </h1>
            <motion.button
              onClick={toggleDarkMode}
              whileTap={{ scale: 0.95 }}
              className="p-1.5 rounded-lg transition-all duration-300 hover:bg-[#00386D]/10 dark:hover:bg-[#6699CC]/20"
            >
              {isDarkMode ? (
                ...
                <svg className="w-4 h-4 text-[#00386D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex-1 px-4 py-4">
          ...
          <div className="text-center mb-4">
            <h2 className="text-xl font-black text-[#00386D] dark:text-[#F7FAFC] tracking-tight mb-1">
              Select Language
            </h2>
            <p className="text-[11px] font-medium text-[#4A5568] dark:text-[#94A3B8]">
          ...
          <div className="mb-4">
            <div className="relative">
              <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#4A5568] dark:text-[#94A3B8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <input
                ...
                className="w-full py-2.5 pl-9 pr-3 text-sm rounded-xl border border-[#BDBCBD] dark:border-white/10 bg-white dark:bg-[#1A202C]/80 text-[#00386D] dark:text-[#F7FAFC] placeholder:text-[#4A5568] dark:placeholder:text-[#94A3B8] focus:outline-none focus:border-[#6699CC] transition-all duration-300"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5 mb-4 max-h-[50vh] overflow-y-auto">
            <AnimatePresence>
              {filteredLanguages.map((lang, index) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full py-2.5 px-3 rounded-lg border transition-all duration-300 flex items-center justify-between ${
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-[9px] font-medium text-[#4A5568] dark:text-[#94A3B8]">
                        {lang.nativeName}
                      </div>
                    </div>
                  </div>
            ...
            {filteredLanguages.length === 0 && (
              <div className="text-center py-6">
                <p className="text-xs text-[#4A5568] dark:text-[#94A3B8]">No languages found</p>
              </div>
            )}
          </div>

          <div className="mb-4">
            <label className="flex items-center justify-between p-2.5 rounded-lg border border-[#BDBCBD] dark:border-white/10 bg-white dark:bg-[#1A202C]/80 cursor-pointer transition-all duration-300 hover:border-[#6699CC]">
              <div>
                <div className="text-xs font-black text-[#00386D] dark:text-[#F7FAFC]">
                  Remember my language
                </div>
                <div className="text-[7px] font-bold text-[#4A5568] dark:text-[#94A3B8] mt-0.5">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full py-2.5 rounded-lg bg-[#00386D] dark:bg-[#6699CC] text-white font-black text-sm tracking-wide transition-all duration-300 hover:opacity-90"
          >
            Continue
          </motion.button>
